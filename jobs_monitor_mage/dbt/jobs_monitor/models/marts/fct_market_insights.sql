...
It shows which platforms or locations have the most job listings, and how the distribution of job levels (Senior, Junior, Mid-Level/Unspecified) varies across different platforms and locations.
*/
...
select
    ...
    job_level,
    location,
    count(*) as job_count -- count of job listings for each combination of platform, location, and job level
...
group by 1, 2, 3, 4 -- group by published date, platform, job location, and job level
